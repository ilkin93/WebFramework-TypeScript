...
function () {
  ...
  Model.prototype.fetch = function () {
    ...
    if (typeof id !== 'number') {
      throw new Error('Can fetch without id');
    }
...
/** @class */
function () {
  function Collections(rootUrl, deserialize) {
    this.rootUrl = rootUrl;
...
exports.User = User;
},{"./model":"src/models/model.ts","./attributes":"src/models/attributes.ts","./sync":"src/models/sync.ts","./eventing":"src/models/eventing.ts","./collections":"src/models/collections.ts"}],"src/views/view.ts":[function(require,module,exports) {
"use strict";
...
var userForm = new userForm_1.UserForm(document.getElementById('rootElement'), user);
userForm.render();
